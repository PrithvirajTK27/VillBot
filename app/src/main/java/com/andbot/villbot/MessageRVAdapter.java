...
public class MessageRVAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        switch (modal.getSender()) {
            case "user":
                ((UserViewHolder) holder).anim.setAnimation(modal.getBmg());
                ((UserViewHolder) holder).userTV.setTextColor(modal.getColor_tv());
                ((UserViewHolder) holder).userTV.setText(modal.getMessage());
                break;
            case "bot":
                ((BotViewHolder) holder).botTV.setTextColor(modal.getColor_tv());
    ...
    public static class UserViewHolder extends RecyclerView.ViewHolder {
        ...
        public UserViewHolder(@NonNull View itemView) {
            ...
            anim = itemView.findViewById(R.id.animation_user);
        }
    }
